...
export function AccessControlModal({ isOpen, onClose, vault }: AccessControlModalProps) {
    ...
    const fetchUsers = async () => {
        const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/vault/${vault.id}/users`)
    ...
    const handleGrantUserAccess = async () => {
        ...
        try {
            // Simulate API call
            const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/grant-user-access`, {
                vaultId: vault.id,
    ...
    const handleRevokeUserAccess = async (userAddress: string) => {
        ...
        try {
            ...
            const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/revoke-user-access`, {
                vaultId: vault.id,
                userAddress,
            });
